    ...
    function drawVNF_interfaces(interfaces){
            ...
            interfaces_section.selectAll(".NewInterface")
                ...
                .attr("r",r_interface)
                .attr("title",function(d){return d.fullId;})
    ...
    function drawBSLinks(elements){
        var lines = lines_section.selectAll(".NewBSLine")
            ...
            .attr("class",function(d){
                /* if both point are bs interfaces internal bs_link, else are external link*/
                if(d.start.indexOf("bs")===0 && d.end.indexOf("bs")===0){
                    return "BS-line";
                }else{
                    return "externalBSLink";
                }
            })
            .attr("stroke","black")
